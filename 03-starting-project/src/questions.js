export default [
  {
    ...
    answers: [
      'CORRECT A library to build user interfaces with help of declarative code.',
  ...
  },
  {
    ...
    answers: [
      'CORRECT Enabling the use of state and other React features in functional components.',
  ...
  },
  {
    ...
    answers: [
      'CORRECT By defining a JavaScript function that returns a renderable value.',
  ...
  },
  {
    ...
    answers: [
      'CORRECT An object in a component that holds values and may cause the component to render on change.',
  ...
  },
  {
    ...
    answers: [
      'CORRECT By using the map() method to iterate over an array of data and returning JSX.',
  ...
  },
  {
    ...
    answers: [
      'CORRECT Using a the #if template syntax.',
